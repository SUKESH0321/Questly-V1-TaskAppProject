    ...
    <div className="max-w-3xl mx-auto p-4 md:p-8 pt-8">
      <div className="flex items-center mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">Step {currentStep + 1} of {steps.length}: {steps[currentStep]}</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between mb-10 relative">
        ...
        {steps.map((step, index) => (
          <div key={index} className="flex flex-col items-center gap-2">
            ...
            <span className={`text-xs font-medium hidden md:block ${index <= currentStep ? 'text-foreground' : 'text-muted-foreground'}`}>
              {step}
            </span>
          </div>
        ))}
      ...
      <div className="bg-card border border-border p-6 md:p-8 rounded-2xl shadow-sm">
        ...
        {currentStep === 1 && (
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in">
            ...
            <p className="text-muted-foreground">Photos help taskers understand what needs to be done.</p>
            ...
            <div className="border-2 border-dashed border-border rounded-xl p-10 flex flex-col items-center justify-center text-center hover:bg-muted/50 transition-colors cursor-pointer group">
              ...
              <p className="text-muted-foreground text-sm mt-1">SVG, PNG, JPG or GIF (max. 5MB)</p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in">
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                <Button variant="outline" className="flex-1 py-8 flex-col gap-2">
              ...
              <div className="pt-4">
                <label className="text-sm font-medium mb-1 block">Or enter address manually</label>
                <Input 
          ...
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="border border-border rounded-xl p-6 text-center flex flex-col justify-center items-center">
                ...
                <div className="font-medium text-foreground mb-2">Set custom budget</div>
                <Input 
                  type="number" 
        ...
        {currentStep === 5 && (
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in">
            ...
            <div className="bg-muted p-6 rounded-xl space-y-4">
              <div>
                <h3 className="font-bold text-lg">{formData.title || "Untitled Task"}</h3>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
                ...
                <div>
                  ...
                  <div className="font-medium">{formData.location || "123 Main St, New York"}</div>
                </div>
                <div>
      ...
      <div className="flex justify-between mt-8">
        ...
        <Button size="lg" onClick={handleNext} className="min-w-[120px]" disabled={!canProceed()}>
